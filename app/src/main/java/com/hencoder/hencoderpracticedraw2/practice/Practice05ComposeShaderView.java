...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader logoShader = new BitmapShader(batmanLogoBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader batmanShader = new BitmapShader(batmanBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shader = new ComposeShader(batmanShader,logoShader, PorterDuff.Mode.DST_IN);
